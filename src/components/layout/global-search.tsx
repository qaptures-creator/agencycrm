...
import { Search, Building2, User, Clapperboard, PackageCheck, Users2, Loader2 } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <span className="flex-1 text-left">Search leads, clients, projects…</span>
          ...
          >
            <div className="flex items-center gap-2 border-b border-border px-4">
              ...
              <Command.Input
                ...
                placeholder="Search leads, clients, contacts, projects, shoots, deliverables…"
