  ...
  return (
    <>
      <button
        ...
        className="flex h-9 w-full min-w-0 max-w-sm items-center gap-2 rounded-lg border border-input bg-secondary/40 px-2.5 text-[13px] text-muted-foreground transition-colors hover:bg-secondary sm:px-3 sm:text-sm"
      >
        <Search className="size-4 shrink-0" />
        <span className="min-w-0 flex-1 truncate text-left">
          <span className="sm:hidden">Search…</span>
          <span className="hidden sm:inline">Search members, staff, tasks…</span>
        </span>
        <kbd className="hidden shrink-0 rounded border border-border bg-card px-1.5 py-0.5 text-[10px] font-medium sm:inline">
          ⌘K
        </kbd>
      </button>
